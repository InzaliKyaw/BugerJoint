...
class DatabaseTest {
    private lateinit var burgeDao: BurgerDao
    ...
    fun insertDatabase(){
        ...
        burgeDao.insert(burgerOne)
        assert(burgeDao.findBurgerById(burgerOne.burgerId).value?.burgerId == burgerOne.burgerId)
    }
